                ...
                if ('RT @' not in tg_text):
                    ...
                    if has_media:
                        bot.sendMessage(chat_id=chatid,
                                        text=tg_text + "\n" + tweet_url + "\n" + "Via" + "|" + "<a href='" + tweet_link + "'>" + tw_name + "</a>" + "|",
                                        timeout=200, disable_web_page_preview=False, parse_mode=ParseMode.HTML)

                        bot.sendMessage(chat_id=channelid,
                                        text=tg_text + "\n" + tweet_url + "\n" + "Via" + "|" + "<a href='" + tweet_link + "'>" + tw_name + "</a>" + "|",
                                        timeout=200, disable_web_page_preview=False, parse_mode=ParseMode.HTML)
                    else:
                        bot.sendMessage(chat_id=chatid,
                                        text=tg_text + "\n" + tweet_url + "\n" + "Via" + "|" + "<a href='" + tweet_link + "'>" + tw_name + "</a>" + "|",
                                        timeout=200, disable_web_page_preview=True, parse_mode=ParseMode.HTML)
